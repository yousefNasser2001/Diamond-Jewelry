                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px"
                        ...
                        <div class="menu-item px-3 my-0">
                            <a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="light">
                                ...
                                <span class="menu-title">{{translate('headerTranslation.Light')}}</span>
                            </a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3 my-0">
                            <a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="dark">
                                ...
                                <span class="menu-title">{{translate('headerTranslation.Dark')}}</span>
                            </a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3 my-0">
                            <a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="system">
                                ...
                                <span class="menu-title">{{translate('headerTranslation.System')}}</span>
                            </a>
                        </div>
                        <!--end::Menu item-->
                    </div>
                    ...
                    <div class="app-navbar-item ms-1 ms-lg-3">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                            <!--begin::Heading-->
                            <div class="d-flex flex-row justify-content-between bgi-no-repeat rounded-top" style="background-image: url('{{ asset('assets/media/misc/menu-header-bg.jpg') }}');">
                                <!--begin::Title-->
                                <h3 class="text-white fw-semibold px-9 mt-10 mb-6">{{translate('notification.Notification')}}
                                    <span class="fs-8 opacity-75 ps-3">{{Auth::user()->unreadNotifications->count()}}</span>
                                </h3>
                                <div class="text-white px-9 mt-10 mb-6">
                                    <a href="{{route('Notification.markAsRead')}}" class="fs-6 text-white text-hover-dark fw-bold">{{translate('notification.ReadAll')}}</a>
                                </div>
                                <!--end::Title-->
                            </div>
                            <!--end::Heading-->
                            ...
                            <div class="d-flex flex-column bgi-no-repeat rounded-top">
                                ...
                                @if(Auth::user()->unreadNotifications()->count() > 0)
                                    <div class="scroll-y mh-325px my-5 px-8" >
                                        @foreach(Auth::user()->unreadNotifications()->orderBy('created_at','DESC')->take(5)->get() as $notification)
                                        <!--begin::Item-->
                                            ...
                                            <div class="d-flex align-items-center" >
                                                ...
                                                <div class="symbol symbol-35px me-4">
                                                    <span class="symbol-label bg-light-primary">
                                                        ...
                                                        <span @if ($notification->read_at == null) class="svg-icon svg-icon-2 svg-icon-primary" @else class="svg-icon svg-icon-2 svg-icon-muted" @endif>
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <!--begin::Title-->
                                                <div class="mb-0 me-2">
                                                    <a href="{{ route('Notification.readOneNotification', ['notification_id' => $notification->id]) }}" class="fs-6 text-gray-800 text-hover-primary fw-bold">
                                                        {{ $notification->data['name'] }}
                                                    </a>                                                    <div class="text-gray-400 fs-7">{{$notification->data['body']}}</div>
                                                </div>
                                                <!--end::Title-->
                                            </div>
                                            <!--end::Section-->
                                ...
                                @else
                                    <div class="scroll-y mh-325px my-5 px-8">
                                        {{translate('notification.ThereIsNoNotification')}}
                                    </div>
                                @endif
                                <!--end::Items-->
                                <!--begin::View more-->
                    ...
                    <div class="app-navbar-item ms-1 ms-lg-3">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-semibold py-4 fs-6 w-175px"
                             data-kt-menu="true">
                            <!--begin::Menu item-->
                            @foreach (\Illuminate\Support\Facades\Config::get(LANGUAGE) as $lang=>$language)
                                <div class="menu-item px-3">
                                    <a href="{{route('lang.switch' , $lang)}}"
                                       class="menu-link d-flex px-5 {{Cookie::get(APP_LOCALE) == $lang ? "active" : ""}}">
                    ...
                    <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                            ...
                            <div class="menu-item px-5">
                                <a onclick="logout()"
                                   class="menu-link px-5">{{translate('headerTranslation.SignOut')}}</a>
                            </div>
                            <!--end::Menu item-->
                        </div>
                        <!--end::User account menu-->
