...
<html lang="{{ Cookie::get(APP_LOCALE) ?? 'ar' }}" dir="{{ (Cookie::get(APP_LOCALE) ?? 'ar') == 'ar' ? 'rtl' : 'ltr' }}">
<!--begin::Head-->
...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/img/shortcut_icon.svg') }}" />
    ...
    @if (Cookie::get(APP_LOCALE) != 'en')
        ...
        <link href="{{ asset('assets/plugins/custom/datatables/datatables.bundle.rtl.css') }}" rel="stylesheet"
            type="text/css" />
        <link href="{{ asset('admin-panel/plugins/global/plugins.bundle.rtl.css') }}" rel="stylesheet"
            type="text/css" />
    ...
    @else
        ...
        <link href="{{ asset('assets/plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet"
            type="text/css" />
        <link href="{{ asset('admin-panel/plugins/global/plugins.bundle.css') }}" rel="stylesheet" type="text/css" />
