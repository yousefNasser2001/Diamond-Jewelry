    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold px-3" id="#kt_app_sidebar_menu"
                ...
                @can(CURRENCY_DELARS_MANAGEMENT_PERMISSION)
                    <div data-kt-menu-trigger="click"
                        class="menu-item menu-accordion {{ hereShowRoutes(['currency_delars.index', 'currency_delars.show']) }}">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/files/fil003.svg-->
                            ...
                            <span class="menu-title">ادارة تجار العملة</span>
                            <span class="menu-arrow"></span>
                        </span>
                        <!--end:Menu link-->
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item menu-accordion mb-1">
                                <!--begin:Menu link-->
                                @can(CURRENCY_DELARS_PERMISSION)
                                    <a class="menu-link" href="{{ route('currency_delars.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">تجار العملة</span>
                                    </a>
                                @endcan
                                <!--end:Menu link-->
                                <!--begin:Menu link-->
                ...
                @can(GOLD_DELARS_MANAGEMENT_PERMISSION)
                    <div data-kt-menu-trigger="click"
                        class="menu-item menu-accordion {{ hereShowRoutes(['gold_delars.index', 'gold_delars.show']) }}">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/files/fil003.svg-->
                            ...
                            <span class="menu-title">ادارة تجار الذهب</span>
                            <span class="menu-arrow"></span>
                        </span>
                        <!--end:Menu link-->
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item menu-accordion mb-1">
                                <!--begin:Menu link-->
                                @can(GOLD_DELARS_PERMISSION)
                                    <a class="menu-link" href="{{ route('gold_delars.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">تجار الذهب</span>
                                    </a>
                                @endcan
                                <!--end:Menu link-->
                                <!--begin:Menu link-->
                ...
                @can(CONTRIBUTORS_MANAGEMENT_PERMISSION)
                    <div data-kt-menu-trigger="click"
                        class="menu-item menu-accordion {{ hereShowRoutes(['contributors.index', 'contributors.show']) }}">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/files/fil003.svg-->
                            ...
                            <span class="menu-title">ادارة المساهمين</span>
                            <span class="menu-arrow"></span>
                        </span>
                        <!--end:Menu link-->
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item menu-accordion mb-1">
                                <!--begin:Menu link-->
                                @can(CONTRIBUTORS_PERMISSION)
                                    <a class="menu-link" href="{{ route('contributors.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                ...
                @can(DEPOSITS_MANAGEMENT_PERMISSION)
                    <div data-kt-menu-trigger="click"
                        class="menu-item menu-accordion {{ hereShowRoutes(['deposits.index', 'deposits.show']) }}">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/files/fil003.svg-->
                            ...
                            <span class="menu-title">ادارة الايداعات</span>
                            <span class="menu-arrow"></span>
                        </span>
                        <!--end:Menu link-->
                        <!--begin:Menu sub-->
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item menu-accordion mb-1">
                                ...
                                @can(DEPOSITS_PERMISSION)
                                    <a class="menu-link" href="{{ route('deposits.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">ايداعات الماسة</span>
                                    </a>
                                @endcan
                ...
                @can(SAFE_MANAGEMENT_PERMISSION)
                    <div data-kt-menu-trigger="click"
                        class="menu-item menu-accordion {{ hereShowRoutes(['safe-page']) }}">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                            ...
                            <span class="menu-title">ادارة الخزنة</span>
                            <span class="menu-arrow"></span>
                        </span>
                        <!--end:Menu link-->
                        <!--begin:Menu sub-->
                ...
                @can(INVENTORY_MANAGEMENT_PERMISSION)
                    <div data-kt-menu-trigger="click"
                        ...
                        <span class="menu-link">
                            ...
                            <span class="menu-title">ادارة الجرد</span>
                            <span class="menu-arrow"></span>
                        </span>
                        <!--end:Menu link-->
                        <!--begin:Menu sub-->
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item menu-accordion mb-1">
                                <!--begin:Menu link-->
                                @can(INVENTORY_PERMISSION)
                                    <a class="menu-link" href="{{ route('inventories.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">الجرد</span>
                                    </a>
                                @endcan
                                <!--end:Menu link-->
                            </div>
                ...
                @can(SETTINGS_MANAGEMENT_PERMISSION)
                    <div data-kt-menu-trigger="click"
                        class="menu-item menu-accordion {{ hereShowRoutes(['features.index']) }}">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/graphs/gra006.svg-->
