            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('withdrawals.index') }}" class="text-muted text-hover-primary">سحوبات
                                العاملين</a>
                        </li>
                        <!--end::Item-->
                    </ul>
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-users-table-filter="search"
                                    ...
                                    placeholder="ابحث عن سحوبات للعاملين" />
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <!--begin::Add Category-->
                                @can(CREATE_WITHDRAWAL_PERMISSION)
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header" id="kt_modal_add_user_header">
                                            <!--begin::Modal title-->
                                            <h2 class="fw-bold">اضافة سحب جديد </h2>
                                            <!--end::Modal title-->
                                            <!--begin::Close-->
                                                ...
                                                <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <select name="employee_id" class="form-select form-select-solid"
                                                            ...
                                                            data-placeholder="{{ translate('expenseTranslation.employee') }}"
                                                            required>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">تاريخ السحب</th>
                                        <th class="min-w-125px">تفاصيل</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="d-flex flex-column">
                                                    <a @can(READ_EMPLOYEE_PERMISSION) href="{{ route('employees.show', $w->employee->id) }}" @endcan
                                                        class="text-gray-800 text-hover-primary mb-1">{{ $w->employee->name }}</a>
                                                </div>
                                                <!--begin::Category details-->
                                            </td>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    data-kt-menu="true">
                                                    <!--begin::Menu item-->
                                                    @can(READ_WITHDRAWAL_PERMISSION)
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('withdrawals.show', $w->id) }}"
                                                                class="menu-link px-3">{{ translate('employeeTranslation.View') }}</a>
                                                        </div>
                                                    @endcan
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @can(DELETE_WITHDRAWAL_PERMISSION)
                                                        <div class="menu-item px-3">
                                                            <form action="{{ route('withdrawals.destroy', $w->id) }}"
