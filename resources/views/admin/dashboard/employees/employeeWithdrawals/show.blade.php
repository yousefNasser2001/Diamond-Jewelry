                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('withdrawals.index') }}"
                                class="text-muted text-hover-primary">سحوبات العاملين</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                        ...
                        <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-center flex-column py-5">
                                    ...
                                    <!--begin::Name-->
                                    <a href="#"
                                        class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3">{{ $withdrawal->employee->name }}</a>
                                    <!--end::Name-->
                                    <!--end::Info-->
                                </div>
                                <!--end::Category Info-->
                                ...
                                <div class="d-flex flex-stack fs-4 py-3">
                                    ...
                                    @can(UPDATE_WITHDRAWAL_PERMISSION)
                                        ...
                                        <div class="menu-item px-3">
                                            <form action="{{ route('withdrawals.destroy', $withdrawal->id) }}" method="post"
                                                ...
                                                <a href="#" class="menu-link text-danger px-5"
                                                    data-kt-users-table-filter="delete_row">حذف السحب</a>
                                            </form>
                                        </div>
            ...
            <div class="modal fade" id="kt_modal_update_details" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        <!--begin::Form-->
                        <form class="form" action="{{ route('withdrawals.update', $withdrawal->id) }}" method="POST"
                            ...
                            <div class="modal-body py-10 px-lg-17">
                                ...
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_user_scroll"
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="number" name="amount" value="{{ $withdrawal->amount }}"
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" name="notes" value="{{ $withdrawal->notes }}"
                                            class="form-control form-control-solid mb-3 mb-lg-0"
                                            placeholder="ملاحظات"
                                            required />
                                        <!--end::Input-->
...
@push('scripts')
        ...
        <script>
            $(document).ready(function() {
                $(document).on('click', '[data-kt-users-table-filter="delete_row"]', function(event) {
                    ...
                    Swal.fire({
                        text: "هل انت متاكد انك تريد حذف هذا السحب  !?",
                        icon: "warning",
    ...
    @else
        <script src="{{ asset('assets/js/custom/apps/withdrawals/view/update-withdrawal-en.js') }}"></script>
        ...
        <script>
            $(document).ready(function() {
                $(document).on('click', '[data-kt-users-table-filter="delete_row"]', function(event) {
                    ...
                    const form = deleteButton.closest('form');
                    Swal.fire({
                        text: "Are you sure you want to delete this Withdrawal?",
                        icon: "warning",
                        showCancelButton: true,
                        buttonsStyling: false,
