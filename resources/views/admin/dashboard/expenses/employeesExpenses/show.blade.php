            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                        {{ translate('expenseTranslation.view_expense_detail') }}</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                            ...
                            <div class="card-body">
                                ...
                                <div id="kt_expense_view_details" class="collapse show">
                                    <div class="pb-5 fs-6">
                                        ...
                                        <div class="fw-bold mt-5">{{ translate('expenseTranslation.employee') }}</div>
                                        <div class="text-gray-600">{{ $expense->employee->name }}</div>

                                        <div class="fw-bold mt-5"> {{ translate('expenseTranslation.description') }}</div>
                    ...
                    <div class="modal-content">
                        ...
                        <form class="form" action="{{ route('expenses.update', $expense->id) }}" method="POST"
                            ...
                            <div class="modal-header" id="kt_modal_update_expense_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold"> {{ translate('expenseTranslation.update_expense_details') }} </h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                            ...
                            <div class="modal-body py-10 px-lg-17">
                                ...
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_expense_scroll"
                                    ...
                                    data-kt-scroll-wrappers="#kt_modal_update_expense_scroll" data-kt-scroll-offset="300px">
