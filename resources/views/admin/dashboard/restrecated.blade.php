    ...
    <div class="d-flex flex-column flex-column-fluid">
                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                        ...
                        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                            ...
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                ...
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="breadcrumb-item text-muted">الخزنة</li>
                                <!--end::Item-->
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    ...
                    <div id="kt_app_content_container" class="app-container container-fluid">
                                ...
                                <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5 mb-xl-10"
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-title d-flex flex-column">
                                            ...
                                            <!--begin::Subtitle-->
                                            <br>
                                            <p class="text-white opacity-75 pt-1 fw-semibold fs-6">اجمالي سحوبات العاملين
                                            </p>
                                            <!--end::Subtitle-->
                                        </div>
                                        <!--end::Title-->
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-title d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <!--begin::Currency-->
                                                <span class="card-title text-gray-800">تجار العملة</span>
                                                <!--end::Currency-->
                                                <!--begin::Amount-->
                                ...
                                <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-title d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <!--begin::Currency-->
                                                <span class="card-title text-gray-800">المساهمين</span>
                                                <!--end::Currency-->
                                                <!--begin::Amount-->
                                                <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2"></span>
                                                <!--end::Amount-->
                                ...
                                <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-title d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <!--begin::Currency-->
                                                <span class="card-title text-gray-800">تجار الذهب</span>
                                                <!--end::Currency-->
                                                <!--begin::Amount-->
                                                <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2"></span>
                                                <!--end::Amount-->
                                ...
                                <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-title d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <!--begin::Currency-->
                                                <span class="card-title text-gray-800">سحوبات الماسة</span>
                                                <!--end::Currency-->
                                                <!--begin::Amount-->
                                                <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2"></span>
                                                <!--end::Amount-->
                        ...
                        <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                            ...
                            <!--Div 69-->
                            <!--begin::Col-->
                            <div class=" col-lg-3 col-xl-3 col-xxl-3 mb-xl-10">
                                <!--begin::Card widget 20-->
                                <div class="card card-flush mb-5 mb-xl-10">
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-title d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <!--begin::Currency-->
                                                <span class="card-title text-gray-800">اجمالي الايداعات</span>
                                                <!--end::Currency-->
                                                <!--begin::Amount-->
                                                <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2"></span>
                                                <!--end::Amount-->
                                ...
                                <div class="card card-flush mb-5 mb-xl-10">
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-title d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <!--begin::Currency-->
                                                <span class="card-title text-gray-800">اجمالي الديون لنا</span>
                                                <!--end::Currency-->
                                                <!--begin::Amount-->
                                                <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2"></span>
                                                <!--end::Amount-->
                            ...
                            <!-- Highlights -->
                            <div class=" col-lg-6 col-xl-6 mb-xl-10">
                                <!--begin::List widget 25-->
                                <div class="card card-flush mb-5 mb-xl-10">
                                    <!--begin::Header-->
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-title d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <!--begin::Currency-->
                                                <span class="card-title text-gray-800">اجمالي الديون علينا</span>
                                                <!--end::Currency-->
                                                <!--begin::Amount-->
                                                <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2"></span>
                                                <!--end::Amount-->
                                        ...
                                        <div class="d-flex flex-column content-justify-center flex-row-fluid">
                                            ...
                                            <div id="labelSelectorContainer">
                                                ...
                                                <select id="labelSelector" class="form-select">
                                                    ...
                                                    <!-- Add other label options here -->
                                                </select>
                                            </div>

                                            <div class="selected-label-container">
                                                <!-- Selected label will be displayed here -->
                                            </div>
                                        </div>
                                        <!--end::Labels-->
                                    </div>
                        ...
                        <div class="row gx-xl-0 d-flex justify-content-between">
                            ...
                            <div class="card card-flush col-xl-5 mb-5 mb-xl-10">
                                ...
                                <div class="card-header pt-5">
                                    ...
                                    <div class="card-title d-flex flex-column">
                                        <!--begin::Amount-->
                                        <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">{{ $UserNumber }}</span>
                                        <!--end::Amount-->
                                        <!--begin::Subtitle-->
                                        <span class="text-gray-400 pt-1 fw-semibold fs-6">عدد المستخدمين</span>
                                        <!--end::Subtitle-->
                                    </div>
                                    <!--end::Title-->
                                </div>
        ...
        <script>
            $(document).ready(function() {
                var labels = {
                    "مشروبات": <?php echo $drinks; ?>,
                    "وجبات طعام": <?php echo $meals; ?>,
                    "مشتريات": <?php echo $purchases; ?>,
                    "انترنت": <?php echo $Internet; ?>,
                    "كهرباء": <?php echo $electricity; ?>,
                    "مولد": <?php echo $Generator; ?>,
                    "صيانة": <?php echo $maintenance; ?>,
                    "صيانة ذهب": <?php echo $GoldMaintenance; ?>,
                    "غير ذلك": <?php echo $otherwise; ?>,
                };

                function generateLabel(title, value) {
                    var labelHtml = `
                        <div class="d-flex fw-semibold align-items-center">
                ...
                $("#labelSelector").change(function() {
                    ...
                    var selectedValue = labels[selectedLabel];
                    $(".selected-label-container").html(generateLabel(selectedLabel, selectedValue));
                });
            });
        </script>
    @endsection
