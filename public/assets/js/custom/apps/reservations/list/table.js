    ...
    let handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    text: "هل أنت متأكد من أنك تريد حذف " + reservationName + "?",
                    icon: "warning",
    ...
    const handleVerfiedReservationPaynment = () => {
        ...
        payButtons.forEach(d =>{
            d.addEventListener('click',function(e){
                ...
                Swal.fire({
                    text: "هل أنت متأكد من أنك تريد الدفع للحجز " + reservationName + "?",
                    icon: "warning",
                    showCancelButton: true,
                    buttonsStyling: false,
                    ...
                    if (result.value) {
                        if(paynmentStatusTd.innerText === 'مدفوع'){
                            Swal.fire({
                                text:"لا يمكن دفع الحجوزات المدفوعة مرة أخرى",
                                icon:"error",
                                buttonsStyling: false,
                                confirmButtonText: "حسنا، اذهب",
                                customClass: {
                            ...
                            Swal.fire({
                                text:"لا يمكن دفع الحجوزات الملغية او المنتهية",
                                icon:"error",
                                buttonsStyling: false,
                                confirmButtonText: "حسنا، اذهب",
                                customClass: {
