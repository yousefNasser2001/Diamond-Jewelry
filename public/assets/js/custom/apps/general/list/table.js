...
$("#kt_modal_add_expenses_2_datepicker").flatpickr({
    enableTime: true,
    dateFormat: "Y-m-d H:i",
});
...
var KTGeneralList = function () {
        ...
        closeButton.addEventListener('click', e => {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    modal.hide(); // Dismiss the modal
                    document.body.classList.remove('modal-open'); // Remove the 'modal-open' class from the body
                    document.body.style.paddingRight = ''; // Reset body padding right
    ...
    let handleAddMasaExpense = () => {
        // Shared variables
        const element = document.getElementById('kt_modal_add_expense');
        const form = element.querySelector('#kt_modal_add_expense_masa_form');
        ...
        // Submit button handler
        const submitButton = element.querySelector('[data-kt-expenses-masa-modal-action="submit"]');
        submitButton.addEventListener('click', e => {
            e.preventDefault();
