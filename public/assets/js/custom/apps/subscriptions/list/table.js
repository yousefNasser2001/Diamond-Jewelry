...
const KTSubscriptionList = function () {
    ...
    let handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    text: "هل أنت متأكد من أنك تريد حذف " + subscriptionName + "?",
                    icon: "warning",
                    ...
                    if (result.value) {
                        ...
                        Swal.fire({
                            text: subscriptionName + " لم يتم حذفها .",
                            icon: "error",
                            buttonsStyling: false,
                            confirmButtonText: "حسنا ، اذهب!",
                            customClass: {
    ...
    let initToggleToolbar = () => {
        ...
        deleteSelected.addEventListener('click', function () {
            // SweetAlert2 pop up --- official docs reference: https://sweetalert2.github.io/
            Swal.fire({
                text: "هل أنت متأكد من أنك تريد حذف الحجوزات المختارة",
                icon: "warning",
                showCancelButton: true,
                buttonsStyling: false,
                confirmButtonText: "نعم ، احذف!",
                ...
                if (result.value) {
                    ...
                    if(stateElementsArray.includes('Pending')){
                        ...
                        $.ajax({
                            url: 'subscriptions/deleteSelected',
                            type: 'POST',
                            data: data,
                            headers: {
                                'X-CSRF-TOKEN': csrfToken
                        ...
                        Swal.fire({
                            text: "لقد حذفت جميع الحجوزات المختارة!.",
                            icon: "success",
                            buttonsStyling: false,
                            confirmButtonText: "حسنا، اذهب",
                            customClass: {
                    ...
                    Swal.fire({
                        text: "الحجوزات المختارة لم يتم حذفها",
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: "حسنا ، اذهب!",
                        customClass: {
    ...
    const handleCancelSubscription = () => {
        ...
        cancelButtons.forEach(d => {
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    text: "هل أنت متأكد من أنك تريد إلغاء الحجز "+ subscriptionName,
                    icon: "warning",
                    showCancelButton: true,
                    buttonsStyling: false,
    ...
    const handleVerfiedSubscriptionPaynment = () => {
        ...
        payButtons.forEach(d =>{
            d.addEventListener('click',function(e){
                ...
                Swal.fire({
                    text: "هل أنت متأكد من أنك تريد الدفع للأشتراك " + subscriptionName + "?",
                    icon: "warning",
                    showCancelButton: true,
                    buttonsStyling: false,
                    ...
                    if (result.value) {
                        if(paynmentStatusTd.innerText === 'مدفوع'){
                            Swal.fire({
                                text:"لا يمكن دفع الاشتراكات المدفوعة مرة أخرى",
                                icon:"error",
                                buttonsStyling: false,
                                confirmButtonText: "حسنا، اذهب",
                                customClass: {
                            ...
                            Swal.fire({
                                text:"لا يمكن تاكيد الدفع للاشتراكات الملغية او المنتهية",
                                icon:"error",
                                buttonsStyling: false,
                                confirmButtonText: "حسنا، اذهب",
                                customClass: {
