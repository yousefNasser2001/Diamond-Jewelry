...
var KTCoursesList = function () {
    let table = document.getElementById('kt_table_courses');
    let datatable;
    let toolbarBase;
    let toolbarSelected;
    let selectedCount;
    ...
    let handleFilterDatatable = () => {
        ...
        const filterForm = document.querySelector('[data-kt-courses-table-filter="form"]');
        const filterButton = filterForm.querySelector('[data-kt-courses-table-filter="filter"]');
    ...
    let handleResetForm = () => {
        // Select reset button
        const resetButton = document.querySelector('[data-kt-courses-table-filter="reset"]');
    ...
    let handleDeleteRows = () => {
        ...
        const deleteButtons = table.querySelectorAll('[data-kt-courses-table-filter="delete_row"]');
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                const courseName = parent.querySelectorAll('td a')[1].innerText;

                // Select all delete form
                const deletForm =  parent.querySelector('[data-kt-courses-table-filter="delete_form"]');

                // SweetAlert2 pop up --- official docs reference: https://sweetalert2.github.io/
                Swal.fire({
                    text: "هل أنت متأكد من أنك تريد حذف " + courseName + "?",
                    icon: "warning",
                    showCancelButton: true,
                    buttonsStyling: false,
                    ...
                    if (result.value) {
                        if(canDeletedElement.value == false){
                            Swal.fire({
                                text:"لا يمكن حذف الكورسات الفعالة",
                                icon:"error",
                                buttonsStyling: false,
    ...
    let initToggleToolbar = () => {
        ...
        deleteSelected.addEventListener('click', function () {
            // SweetAlert2 pop up --- official docs reference: https://sweetalert2.github.io/
            Swal.fire({
                text: "هل أنت متأكد من أنك تريد حذف الكورسات المختارة",
                icon: "warning",
                showCancelButton: true,
                buttonsStyling: false,
                confirmButtonText: "نعم ، احذف!",
                ...
                if (result.value) {
                    ...
                    if(canDeletedElementsArray.includes("")){
                        ...
                        Swal.fire({
                            text: "لقد حذفت جميع الموارد المختارة!.",
                            icon: "success",
                            buttonsStyling: false,
                            confirmButtonText: "حسنا، اذهب",
                            customClass: {
                    ...
                    Swal.fire({
                        text: "الموارد المختارة لم يتم حذفها",
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: "حسنا ، اذهب!",
                        customClass: {
