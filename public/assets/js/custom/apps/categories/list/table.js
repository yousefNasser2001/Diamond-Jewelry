var KTCategoriesList = function () {
    ...
    let handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    text: "هل أنت متأكد من أنك تريد حذف " + CategoryName + "?",
                    icon: "warning",
                    showCancelButton: true,
                    buttonsStyling: false,
                    ...
                    if (result.value) {
                        if(canDeletedElement.value == false){
                            Swal.fire({
                                text:"لا يمكن حذف الأقسام الفعالة",
                                icon:"error",
                                buttonsStyling: false,
    ...
    let initToggleToolbar = () => {
        ...
        deleteSelected.addEventListener('click', function () {
            // SweetAlert2 pop up --- official docs reference: https://sweetalert2.github.io/
            Swal.fire({
                text: "هل أنت متأكد من أنك تريد حذف الأقسام المختارة",
                icon: "warning",
                showCancelButton: true,
                buttonsStyling: false,
                confirmButtonText: "نعم ، احذف!",
                ...
                if (result.value) {
                    ...
                    if(canDeletedElementsArray.includes("")){
                        Swal.fire({
                            text:"لا يمكن حذف الأقسام المحجوزة بالفعل ",
                            icon:"error",
                            buttonsStyling: false,
                            confirmButtonText: "حسنا، اذهب",
                            customClass: {
                        ...
                        Swal.fire({
                            text: "لقد حذفت جميع الأقسام المختارة!.",
                            icon: "success",
                            buttonsStyling: false,
                            confirmButtonText: "حسنا، اذهب",
                            customClass: {
                    ...
                    Swal.fire({
                        text: "الأقسام المختارة لم يتم حذفها",
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: "حسنا ، اذهب!",
                        customClass: {
