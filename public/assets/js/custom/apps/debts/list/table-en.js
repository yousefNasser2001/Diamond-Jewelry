    ...
    let handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    text: "Are you sure you want to delete " + debtName + "?",
                    icon: "warning",
                    showCancelButton: true,
                    buttonsStyling: false,
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    checkboxes.forEach(c => {
                        ...
                        Swal.fire({
                            text: "You have deleted all selected Debts!.",
                            icon: "success",
                            buttonsStyling: false,
                            confirmButtonText: "Ok , Go",
                            customClass: {
                    ...
                    Swal.fire({
                        text: "Selected Debts Does Not Deleted",
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: "Ok , Go",
                        customClass: {
    ...
    const handleVerfiedDebt = () => {
        ...
        payButtons.forEach(d =>{
            d.addEventListener('click',function(e){
                ...
                Swal.fire({
                    text: "Are you sure you want yo pay  " + subscriptionName + "?",
                    icon: "warning",
                    showCancelButton: true,
                    buttonsStyling: false,
                    ...
                    if (result.value) {
                        if(paynmentStatusTd.innerText === 'Paid'){
                            Swal.fire({
                                text:"Can't pay the paid amount",
                                icon:"error",
                                buttonsStyling: false,
                                confirmButtonText: "Ok , go",
                                customClass: {
